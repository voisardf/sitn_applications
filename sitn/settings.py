...
MIDDLEWARE = [
    ...
    # Records who made each change on history-tracked models. Must come after
    # AuthenticationMiddleware, since it reads request.user. Without it
    # history rows written outside the admin carry a NULL history_user.
